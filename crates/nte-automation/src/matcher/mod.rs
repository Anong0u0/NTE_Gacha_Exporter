...
use crate::profile::{AutomationProfile, TemplateSpec, template_bytes};

use self::edge::gradient_magnitude;
use self::ncc::{IntegralPlane, Plane, PreparedPlane, normalized_cross_correlation_prepared};
use self::scale::{CANDIDATE_SCALES, resize_template, scaled_size};
