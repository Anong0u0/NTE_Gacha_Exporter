...
impl AutomationTooltip {
    ...
    pub fn show(&self, message: &str) -> bool {
        ...
        use windows_sys::Win32::UI::WindowsAndMessaging::{
            GetCursorPos, GetSystemMetrics, HWND_TOPMOST, SM_CXSCREEN, SM_CYSCREEN, SW_HIDE,
            SW_SHOWNOACTIVATE, SWP_NOACTIVATE, SWP_SHOWWINDOW, SetWindowPos, SetWindowTextW,
            ShowWindow,
        };
    ...
    fn measure(&self, message: &str) -> (i32, i32) {
        ...
        use windows_sys::Win32::Graphics::Gdi::{
            DT_CALCRECT, DT_LEFT, DT_NOPREFIX, DT_WORDBREAK, DrawTextW, GetDC, ReleaseDC,
        };
