...
const BUNDLED_MAPS: &[(&str, &str)] = &[
    ("de", include_str!("../resources/maps/de.json")),
    ("en", include_str!("../resources/maps/en.json")),
    ("es", include_str!("../resources/maps/es.json")),
    ("fr", include_str!("../resources/maps/fr.json")),
    ("ja", include_str!("../resources/maps/ja.json")),
    ("ko", include_str!("../resources/maps/ko.json")),
    ("ru", include_str!("../resources/maps/ru.json")),
    ("zh-CN", include_str!("../resources/maps/zh-CN.json")),
    ("zh-Hans", include_str!("../resources/maps/zh-Hans.json")),
    ("zh-Hant", include_str!("../resources/maps/zh-Hant.json")),
];
