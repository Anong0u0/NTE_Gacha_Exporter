use crate::maps::{MapData, MapGachaRule};
use crate::model::{
...
pub fn derive_pool_kind_hits(
    ...
    let derived = crate::derived::derive_records(records, map)?;
...
mod tests {
    ...
    fn derive_pool_kind_hits_tracks_five_and_four_star_state() {
        ...
        let derived =
            crate::derived::derive_records(&records, &map).expect("records should derive");
